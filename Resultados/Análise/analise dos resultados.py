...
plt.title('Tempo dos algoritmos com entradas aleatórias')
plt.legend()
...
plt.title('Tempo dos algoritmos com entradas em ordem crescente')
plt.legend()
plt.ylabel('Tempo em nanossegundos')
plt.xlabel('Algoritmos')
plt.show()
...
plt.title('Tempo dos algoritmos com entradas em ordem decrescente')
plt.legend()
plt.ylabel('Tempo em nanossegundos')
plt.xlabel('Algoritmos')
plt.show()
