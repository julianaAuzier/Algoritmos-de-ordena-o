...
void countingSort(int input_array[],int s, int r){
	...
	// colocando os elementos do array de entrada no array de saida com as
	...
	// copiar elementos da matriz de saida para a matriz de entrada
	for(int i=0;i<s;i++)
...
int main(){
	...
	int size= sizeof(nD_100) / sizeof(nD_100[0]); //TROCAR
	int range = 100;

    // Tempo inicial
    auto start = chrono::steady_clock::now();
 
    countingSort(nD_100,size,range); //TROCAR
